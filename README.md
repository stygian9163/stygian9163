...
class WaleedTariq:
    alias      = "styg1an"
    focus      = ["quantitative finance", "machine learning", "cybersecurity"]
    building   = "Fortis Capital — AI-driven hedge fund platform"
    belief     = "alpha is a language. learn to read it."
    currently  = "turning noise into signal, one model at a time"
```
...
An AI-driven asset management platform — built from scratch.

- **HRP** — Hierarchical Risk Parity portfolio optimization  
- **StatArb** — cointegration-based statistical arbitrage  
- **RL Agent** — reinforcement learning for trade execution  
- **Sentiment Engine** — NLP signal layer across news & social  
- **Large Action Model** — autonomous cross-asset trading  

> *a machine that reads markets the way*  
> *a poet reads a room — between the lines*
...
┌─────────────────────────────────────────────────────────────────┐
│                                                                 │
│    ctf competitor  ·  styg1an                                   │
│    competitive swimmer                                          │
│    amateur poet                                                 │
│    crypto investor since 18                                     │
│                                                                 │
│    "the market doesn't care about your feelings.                │
│     neither does the ocean.                                     │
│     learn to move with both."                                   │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
